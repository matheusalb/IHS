...
void writeNumberOnAll7SegmentDisplays(int left, int middle, int right) {
  writeNumberOn7SegmentDisplayLeft(left, middle);
  writeNumberOn7SegmentDisplayRight(right);
}
...
int main(){
  ...
  writeNumberOnAll7SegmentDisplays(12, 34, 5678);
